  ...
  Widget build(BuildContext context) {
    return Builder(builder: (BuildContext context) {
      ...
      if (isAllPublic) {
        ...
        message = 'Everyone can view this picture.';
      } else if (isPrivate) {
        headerIcon = Icon(Icons.lock_rounded, color: Colors.red[900], size: 60);
        message =
            'Only you and your friends in this picture will be able to see it.';
      } else {
        ...
        return Column(
          ...
          children: [
            const Align(
              ...
              child: Icon(Icons.group_rounded, color: Colors.black, size: 35),
            ),
            Padding(
